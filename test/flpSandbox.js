		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mock 1",
									"targetURL": "#jianellimock01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"jianellimock01-display": {
								"semanticObject": "jianellimock01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jianelli.mock01",
									"url": sap.ui.require.toUrl("jianelli/mock01")
								}
							}
						}
					}
